 ...
 *******************************/
export declare type UniformResourceIdentifier = string;
export declare type UniformResourceLabel = string;
export declare type UniformResourceName = string;
export declare type DigitalObjectIdentifier = string;
