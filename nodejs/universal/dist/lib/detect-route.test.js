...
describe('detectFileSysStyleRoute', async () => {
    it('without modifiers', () => {
        const complexPath = '/some/long-ugly/file_sys_path/module-2_Component--_  1,=service_2.md';
    ...
    it('with modifiers', () => {
        const complexPath = '/some/long-ugly/file_sys_path/module-2_Component--_  1,=service_2.mod1.mod2.md';
        const result = mod.detectFileSysStyleRoute(complexPath);
        expect(result);
